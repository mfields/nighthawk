 ...
 *
 * <ul>
 * <li>Adds the "many" class to all views containing multiple posts.</li>
 * <li>Adds the "singular" class to all views containing one post.</li>
 * </ul>
 *
 * @param     array     Classes for the body tag.
 * @return    array     Modified classes for the body tag.
 ...
 * @return    array     All classes for the post container + hentry.
 *
 * @access    private
 * @since     1.0
 */
...
function _ghostbird_author_link( $description ) {
	if ( ! empty( $description ) ) {
		$link = '<a href="' . get_author_posts_url( get_the_author_meta( 'ID' ) ) . '">' . sprintf( __( ' View all posts by %s.', 'ghostbird' ), get_the_author() ) . '</a>';
