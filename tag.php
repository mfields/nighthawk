...
<header id="intro">
	...
	<div id="summary"><?php echo tag_description(); ?></div>
	<div id="intro-meta">
		...
		<span class="subscribe"> <a href="<?php echo esc_url( get_tag_feed_link( $wp_query->get_queried_object_id() ) ); ?>" title="<?php printf( esc_attr__( 'Get updated whenever a new entry is tagged with the term &#8220;%1$s&#8221;.', 'nighthawk' ), single_tag_title( '', false ) ); ?>"><?php esc_html_e( 'Subscribe', 'nighthawk' ); ?></a></span>
	</div>
</header>
